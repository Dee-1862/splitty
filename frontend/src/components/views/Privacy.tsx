          ...
          <div className="space-y-4">
            <button className="w-full text-left p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Export all your data in a portable format</p>
                </div>
              </div>
            </button>
            ...
            <button className="w-full text-left p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">View Data Usage</p>
                  <p className="text-sm text-gray-500">See how your data is being used</p>
                </div>
              </div>
            </button>
